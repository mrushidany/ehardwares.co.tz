                        ...
                        <div class="swiper-container gallery-top mb-20px">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="{{ asset ('ecommerce/assets/web/dist/images/product-image/1.jpg') }}" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="{{ asset ('ecommerce/assets/web/dist/images/product-image/2.jpg') }}" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="{{ asset ('ecommerce/assets/web/dist/images/product-image/3.jpg') }}" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="{{ asset ('ecommerce/assets/web/dist/images/product-image/4.jpg') }}" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="{{ asset ('ecommerce/assets/web/dist/images/product-image/5.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
