    ...
    public function hardware_category_list()
    {
        ...
        return DataTables::of($category_list)
                            ->addColumn('action', function ($list) {
                                $modal = 'hardware_sub_category_modal';
                                $button = '';
                                $button .= '<a href="javascript:edit(\''. route('hardware_categories.update', $list->id) .'\', \''. $modal .'\')" class="btn btn-sm p-0 " data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-bs-original-title="Edit" aria-label="Edit"><span class="text-500 fas fa-edit"></span></a>';
